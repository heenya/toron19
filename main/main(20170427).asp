...
<div class="Top">
  ...
  <ul class="navigation">
    ...
    <ul class="Sub S_navi01" id="sub_menu1" style="display:<% if part1 = "01" then %><% else %>none<% end if%>;">
      ...
      <a href="../about/about03.asp">17회 주제제안문</a>
      </li>
...
#m_visual .main_logo{position:absolute; top:50px; left:0; width:100%; z-index:100; text-align:center;}
...
<div id="m_visual">
  ...
  <div id="slides_main" class="slides_main" >
    <ul class="slide">
      <li><img src="../images/main/top_banner01.jpg" alt="이미지" /></li>
      <li><img src="../images/main/top_banner02.jpg" alt="이미지" /></li>
      <li><img src="../images/main/top_banner03.jpg" alt="이미지" /></li>
      <li><img src="../images/main/top_banner04.jpg" alt="이미지" /></li>
    </ul>
    <div class="playStop">
      <div class="paging">
        <!--<ul>
    ...
    <div class="main_logo">
      <img src="../images/main/topbanner_txt.png" alt="이미지" class="rolling_text" />
  ...
  <a href="/data/data02.asp?Board=PdsPhoto"></a>
	...
	<div class="main_banners">
		<div class="banners_01">
			<h3>주제강연회</h3>
			<a href="/data/data03.asp?Board=PdsMovie&Mode=Read&GotoPage=1&idx=2000"><p class="slogan_01">무엇이 청년들을 부모세대보다 힘들게 하는가?</p></a>
			<dl>
				<dt>일시 : </dt>
				<dd>2016.04.09(토) 오후 2시</dd>
				<dt>장소 : </dt>
				<dd>민주공원 소극장 (작은방)</dd>
				<dt class="long">강사 : </dt>
				<dd>
					<ul>
						<li>김병권</li>
						<li>사회혁신 리서치 랩 소장</li>
						<li>새로운 사회를 여는 연구원 부원장(전)</li>
						<li>필독서 《분노의 숫자》 공저자</li>
					</ul>
				</dd>
			</dl>
		</div>
		...
		<div class="banners_02">
			...
			<dl>
				<dt>예선한마당(논술문 접수)</dt>
				<dd>- 2016.06.20(월) 23:50 접수마감</dd>
				<dt>본선한마당<br /><span>(구술면접, 모둠토론, 한마당식 주도토론)</span></dt>
				<dd>- 일시 : 2016.08.01(월)~03(수)</dd>
				<dd>- 장소 : 민주공원, 부산광역시 학생교육원</dd>
			</dl>
		</div>

		<div class="banners_03">
			<a href="#" Onclick="<%If Now > CDate("2017-06-06 23:50:00") then%>alert('참가신청이 마감되었습니다.'); <%else%>window.open('../Menu/Main/Enter.asp','open_img','width=620,height=800,status=0, resizable=0, scrollbars=1'); <%End if%> ">
				<h3 class="bdb">참가신청</h3>
				<p class="conts">참가신청 후 논문접수 하세요~<br />여러분의  많은 신청<br />부탁드립니다.</p>
			</a>
		</div>

		<div class="banners_04">
			<a href="#" Onclick="<%If Now > CDate("2017-06-06 23:50:00") then%>alert('논문접수가 마감되었습니다.'); <%else%>window.open('../Menu/Main/Enter.Receive.asp','open_img','width=620,height=800,status=0,resizable=0, scrollbars=1'); <%End if%>">
				<h3 class="bdb">논문접수</h3>
				<p class="conts">2016년 6월 20일(월) 23:50까지<br />홈페이지에서 논문접수를<br />받습니다!</p>
			</a>
		</div>

		<div class="banners_05">
			<a href="/about/about05.asp">
				<h3 class="bdb">필독서</h3>
				<p class="conts">한마당을 준비하기 위해서<br />꼭 읽어야 할 책은<br />무엇일까요?</p>
			</a>
		</div>

		<div class="banners_06">
			<a href="/data/data02.asp?Board=PdsPhoto">
				<h3 class="bdb">사진자료실</h3>
				<p class="conts">논술토론한마당의<br />생생한 모습을<br />공유해보아요~</p>
			</a>
		</div>
	</div>
	...
	<div class="notice_banners">
		<div class="banners_07">
			<h3>공지사항</h3>
			<a href="/info/info01.asp?Board=Notice" class="more"><img src="../images/main/more.jpg" alt="더보기" /></a>
			<ul class="list">
			   <%
        ...
        <li>
					<dl>
						<dt><a href="../info/info01.asp?Board=Notice&Mode=Read&GotoPage=1&idx=<%=board_num%>"><%=article_title%></a> <img src="../images/main/new.jpg" alt="new" /></dt>
						<dd><%=reg_date%></dd>
					</dl>
        </li>
		      <% rs.movenext
		...
		<div class="banners_08">
			<h3>묻고답하기</h3>
			<a href="/join/join02.asp?Board=Qna" class="more"><img src="../images/main/more.jpg" alt="더보기" /></a>
			<ul class="list">
			   <%
			       Set rs=conn.execute("select top 4 * from 게시판 where (게시판이름 = 'QnA') And 삭제여부 = 0 order by 번호 desc")
			   %>
			   <%If rs.eof then%>
			        <li>등록된 묻고답하기가 없습니다.</li>
			   <%End if %>
			   <%
			       Do While Not rs.eof
				   board_num = rs("글번호")
