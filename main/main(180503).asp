...
<div class="Top">
  ...
  <div class="bh_navigation">
	<div class="bh_nav_wrap">
		...
		<div class="bh_nav">
			<a href="#" class="bh_home"><img src="../images/main/ico_home.png" alt="" /></a>
	...
	<div class="bh_main_box_wrap">
		<div class="bh_main_box_inner">
			...
			<div class="bh_main_quick">
				<dl>
					<dt>QUICK<br />MENU</dt>
					<dd class="bh_01"><a href=href="/info/info01.asp?Board=Notice">공지사항</a></dd>
			...
			<div class="bh_main_conts">
				<div class="bh_main_conts_left">
					<div class="bh_conts_1">
						<a href="#" class="bh_conts_link">
							<dl>
								<dt>
									<span onclick="<%If Now > CDate("2018-06-18 09:00:00") then%>alert('논문접수가 마감되었습니다.'); <%else%>window.open('../Menu/Main/Enter.asp','open_img','width=620,height=800,status=0,resizable=0, scrollbars=1'); <%End if%>">참가신청</span>
									/ 
									<span onclick="<%If Now > CDate("2018-06-18 09:00:00") then%>alert('논문접수가 마감되었습니다.'); <%else%>window.open('../Menu/Main/Enter.Receive.asp','open_img','width=620,height=800,status=0,resizable=0, scrollbars=1'); <%End if%>">논문접수</span>
								</dt>
								<dd>참가신청 후 논문접수 하세요.<br />여러분의 많은 신청 부탁드립니다.</dd>
							</dl>
						</a>
					</div>
					...
					<div class="bh_conts_3">
						<a href="#" class="bh_conts_link_1">
							<dl>
								<dt>주제강연회</dt>
								<dd>청소년, 정의를 말하다</dd>
							</dl>
						</a>
						<a href="#" class="bh_conts_link_2">
							<dl>
								<dt>글쓰기 특강</dt>
								<dd>2018년 여름방학 글쓰기 특강</dd>
							</dl>
						</a>
					</div>

					<div class="bh_conts_4">
						<a href="http://toron18.demopark.or.kr/data/data02.asp?Board=PdsPhoto" class="bh_conts_link">
							<dl>
								<dt>사진자료실</dt>
